    ...
    <main className="bg-canvas text-ink">
      ...
      <header className="border-b border-border bg-gradient-to-r from-ink via-ink/92 to-accent-700 text-white">
        <div className="container section-shell space-y-5">
          ...
          <div className="flex flex-wrap gap-2 text-xs font-semibold uppercase tracking-[0.16em] text-slate-100">
      ...
      <section className="container section-shell grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-soft/30">
...
function ContactoFallback() {
  return (
    <div className="card-shell p-6 shadow-soft/40">
