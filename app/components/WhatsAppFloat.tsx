...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-green-900/25 transition-transform hover:scale-105 sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
    >
      <svg viewBox="0 0 24 24" fill="white" className="h-6 w-6 sm:h-7 sm:w-7" aria-hidden>
