        ...
        {services.length === 0 ? (
          ...
          <div className="space-y-4">
            {services.map((service) => (
              <details key={service.slug} className="card-shell bg-white px-6 py-4">
                <summary className="cursor-pointer list-none">
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-[0.16em] text-accent-700">{service.slug}</p>
                      <h2 className="text-xl font-heading font-semibold text-ink">{service.title}</h2>
