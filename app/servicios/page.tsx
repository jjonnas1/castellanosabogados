      ...
      >
        ...
        <div className="container section-shell relative space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="max-w-4xl text-white">Servicios ejecutivos en contratación estatal</h1>
      ...
      <section className="container section-shell grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-muted">
            Proporcionamos criterio sólido, control absoluto y serenidad estratégica en cada fase de decisiones críticas y procesos
            contractuales.
          </p>
